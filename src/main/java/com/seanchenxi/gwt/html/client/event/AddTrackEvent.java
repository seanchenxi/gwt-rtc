 ...
 * User: Xi
 */
public class AddTrackEvent extends FnEvent<MediaStreamTrackEvent, AddTrackEvent.Handler> {

    public interface Handler extends EventHandler {
        void onAddTrack(AddTrackEvent event);
    }

    static Type<Handler> TYPE;

    private AddTrackEvent() {
        super();
    }

    public static Type<Handler> getType() {
        if (TYPE == null) {
            TYPE = new Type<Handler>(EventType.ADD_TRACK, new AddTrackEvent());
        }
        return TYPE;
    }
